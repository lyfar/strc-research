...
| 9 | [[STRC Synthetic Peptide Hydrogel HTC]] | A | ⚠ **2/3 lit gaps remain 2026-04-23** | Gate 1 (118 aa tail > 12 aa limit) CLOSED via 5% blend scaffold model (φ_tail=0.05 PASS, 2000× TMEM145 valency excess). Gates 2 (WH2×F-actin Kd) + 3 (STRC×TMEM145 Kd) open. See [[STRC h09 Phase 4e_v2 Blend Scaffold]] + [[STRC h09 Parameter Provenance Audit 2026-04-23]]. |
