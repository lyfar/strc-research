...
| --- | ----------------------------------------------------- | ---- | ----- | ----- | ------------------------------------------------------ | --------------------------------------- | ------- | ---------------------------------------------------------------- |
| 1   | [[STRC Pharmacochaperone Virtual Screen E1659A]]      | 4    | 4     | 4     | Phases 0–3 done; top-5 leads shortlist; [[STRC Pharmacochaperone Phase 4 Plan]] queued (seven computational gates before any wet spend); **Phase 4a PASS 4/5** — pocket reproduces in WT + E1659A + Ultra-Mini ± TMEM145 at drugg 0.82–0.92 ([[STRC Pharmacochaperone Phase 4a Pocket Reproducibility]]); **Phase 4e proxy soft-FAIL** (margin 0.15 vs 0.20; scorer blind to triple-basic K1141/K1172/K1173 cluster — def. read deferred to Phase 4b); **Phase 4b smoke PASS on LE** — diflunisal −6.40, leads −5.02 to −6.05, negatives −2.96 to −4.81; all 5 leads beat diflunisal on ligand efficiency 29–57% ([[STRC Pharmacochaperone Phase 4b Smoke Test]]) | active                                  | **S**   | run Phase 4c WT decoy dock (same roster, WT STRC target) |
