...
| 8   | [[STRC ASO Exon Skipping]]                            | 3    | 3     | 2     | Phase 1 design (54 candidates); local self-fold check **PASS 54/54** ([[STRC ASO Phase1 Fold Check]]); heteroduplex ΔG + RNAplfold accessibility still pending. ⚠ STRCP1 paralog cross-hybridization not yet checked (flagged from [[STRC PE Phase4 STRCP1 Paralog Off-Target]] — paralog has paralogous splice sites) | backburner                              | **B**   | (a) STRCP1 cross-hybridization check (NUPACK/BLAST against STRCP1 splice sites); (b) heteroduplex ΔG (NUPACK); (c) RNAplfold sliding-window accessibility on full intron/exon context |
