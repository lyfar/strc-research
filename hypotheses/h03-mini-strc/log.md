...
- 0 CpG CDS at 3.65% CAI; clinical CDS ready → [[STRC Ultra-Mini CpG Depletion]]
- B8+WPRE3-compact vector architecture locked; Ultra-Mini-enabled only → [[STRC Ultra-Mini Promoter Shortlist]]
- Full-vector CpG audit: 48 CpG / 13.9 per kb, 67% from ITRs (irreducible floor) → [[STRC Ultra-Mini CpG Depletion]]
- Weak homodimer: real weak dimerization surface at ARM 1579-1581 (not AF3 artifact) → [[STRC Homodimer Interface From CIF]]
